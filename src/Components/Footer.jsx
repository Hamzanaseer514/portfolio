          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              >
                ...
                >
                  {/* <!-- Define the logo for 'H' --> */}
                  <defs>
                    <g id="logo-H">
                      <rect x="0" y="0" width="40" height="40" fill="#63b3ed" />
                      <text
                        x="10"
                        y="30"
                        font-size="24"
            ...
            <div class="lg:mx-auto text-left ">
              ...
              <a
                href="javascript:;"
                class="flex items-center justify-center gap-2 border border-indigo-600 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-indigo-600 font-semibold transition-all duration-500 hover:bg-indigo-50"
              >
                Subscribe
                <svg
                  width="15"
